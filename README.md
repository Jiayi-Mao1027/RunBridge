...
- `/data03/liang/mjy/.claude-isolated`
...
- `/data03/liang/mjy/.claude-isolated/CLAUDE.md`
  - current control notes and hook/protocol boundaries
- `/data03/liang/mjy/.claude-isolated/hooks/`
  - executable lifecycle hooks
- `/data03/liang/mjy/.claude-isolated/runtime_state/`
  - durable hook-written state
- `/data03/liang/mjy/.claude-isolated/backups/`
...
Stored under:
- `/data03/liang/mjy/.claude-isolated/runtime_state/projects/<project-key>/task_envelopes/`
...
Stored under:
- `/data03/liang/mjy/.claude-isolated/runtime_state/projects/<project-key>/teammate_status/`
...
Stored under:
- `/data03/liang/mjy/.claude-isolated/runtime_state/projects/<project-key>/completion_receipts/`
...
Stored under:
- `/data03/liang/mjy/.claude-isolated/runtime_state/checkpoint.json`
- `/data03/liang/mjy/.claude-isolated/runtime_state/session_start_last.json`
...
The user-level Claude Code system under `.claude-isolated` owns:
...
For this setup, `.claude-isolated` is the active isolated Claude Code system, not `.claude`.

## Maintenance Rules

When updating the current agent system:
- keep `/data03/liang/mjy/.claude-isolated/settings.json` aligned with actual hook locations
- keep `/data03/liang/mjy/.claude-isolated/CLAUDE.md` aligned with actual runtime behavior
- keep `/data03/liang/mjy/.claude-isolated/hooks/` as the executable source for hook logic
...
1. `/data03/liang/mjy/.claude-isolated/settings.json`
2. `/data03/liang/mjy/.claude-isolated/CLAUDE.md`
3. `/data03/liang/mjy/.claude-isolated/hooks/`
